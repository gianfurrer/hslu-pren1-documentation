...
\noalign{\penalty10000}% Prevent break before
  \noalign{\vskip-\arrayrulewidth}% Avoid introducing vertical space
  \noalign{\penalty10000}% Reinforce no-break rule
  \cline{#1}% Actual cline
  \noalign{\penalty10000}% Prevent break after
  \noalign{\vskip-\arrayrulewidth}% Avoid vertical space after cline
}
\makeatother
\begin{document}
