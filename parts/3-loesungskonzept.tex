...
\begin{figure}[H]
\includegraphics[width=0.9\textwidth]{img/lösungskonzpet/Skizzen/UART_Schnittstelle.png}
...
\begin{figure}[H]
\includegraphics[width=0.9\textwidth]{img/lösungskonzpet/Skizzen/Skizze_Hindernisbewältigung.png}
