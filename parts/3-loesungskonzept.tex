...
\begin{figure}[h!]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/lösungskonzpet/hindernissaufnahme/Greifarm_oben.jpg}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/lösungskonzpet/hindernissaufnahme/Greifarm_unten.jpg}
