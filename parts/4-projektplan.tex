...
\hline
\textbf{ID}  & \textbf{Title} & \textbf{Beschreibung} & \textbf{Ver.} & \textbf{Kategorie} & \textbf{Ursachen} & \textbf{EW} & \textbf{AW} & \textbf{Bew.} \\ \hline
...
\begin{multicols}{4}
    \textbf{Legende:} \\
    \textbf{EW} \> Eintrittswahrscheinlichkeit mit Massnahmen \\
    \textbf{AW} \> Auswirkung mit Massnahmen \\
    \textbf{BW} \> Bewertung mit Massnahmen \\
\end{multicols}
