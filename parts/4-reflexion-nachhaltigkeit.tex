...
\begin{figure}[H] % 'h' steht für here, was bedeutet, dass das Bild möglichst an dieser Stelle eingefügt wird
    \centering
        ...
        \caption{Prinzip: Reduce, Reuse, Recycle}
        \label{fig:enter-label}\footnotemark
    \end{figure} 
