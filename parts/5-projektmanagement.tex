...
Für PREN1 wurden in der Aufgabenstellung \ref{aufgabenstellung} drei Meilensteine und deren Resultate definiert. Meilensteine vier und fünf sind wichtige Abgaben und die Abschlusspräsentation. 
\begin{table}[H]
\centering
...
\textbf{Meilenstein} & \textbf{Abgabe} & \textbf{Resultate} \\ \hline
 ...
 4        & 10.01.2025      &  Schlussbericht Projektdokumentation Lösungskonzept\\ \hline
 5        & 25.01.2025      &  Präsentation Lösungskonzept\\ \hline
...
Weitere Meilensteine werden im Verlauf von PREN2 definiert. Resultate von PREN 2 sind zusätzlich:
\begin{itemize}
\item \textbf{Fahrzeug}
\item \textbf{Vollständige Projektdokumentation}
\end{itemize}
...
Diese Risiken werden am Projektanfang möglichst minimiert. Dies kann beispielsweise anhand von Prototypen, geplanten Backup Lösungen oder vertieften Recherchen\ref{} erfolgen.
