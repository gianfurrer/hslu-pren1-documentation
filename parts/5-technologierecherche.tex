...
\begin{figure}[h!]
        ...
        \caption{Klemme an der Seite des Hindernises}
...
Es wird an der Seite gegriffen, dabei wird die Verbindung, zum Zusammenstecken der Hindernisse, ausgenutzt. Dadurch können zum Greifen auch elastische Materialien verwendet werden.
...
\begin{minipage}[t]{0.48\textwidth}
    \begin{items}
          ...
          \item Kann auf verschiedene Arten Greifen
...
Eine Greifhaken artige Konstruktion, die die Löcher des Hindernisses ausnutzt
