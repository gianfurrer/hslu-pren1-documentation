...
\begin{longtable}[]{@{}lp{5cm}p{7cm}cc}
  \textbf{Nr.}
& \textbf{Anforderung}
& \textbf{Beschreibung}
& \textbf{Kat.}
...
\hline
\endhead
  1.  & \textbf{Allgemeine Anforderungen} & ~ & ~ & ~ \\ \hline
  ...
  2.  & \textbf{Technische Anforderungen} & ~ & ~ & ~ \\ \hline
  ...
  3.  & \textbf{Erkennung des Weges und Wegpunkte} & ~ & ~ & ~ \\ \hline
  ...
  5. & \textbf{Steuerung \& Bedienung} & ~ & ~ & ~ \\ \hline
