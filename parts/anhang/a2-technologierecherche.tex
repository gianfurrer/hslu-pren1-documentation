...
Findet den kürzesten Weg von allen Knoten zu allen anderen Knoten eines Graphen.
...
Der Weg, die Hindernisse sowie die Pylonen müssen anhand von Software erkannt und kategorisiert werden. Um die beiden Objekte voneinander zu unterscheiden, werden die Objekte anhand von Bildern erkannt.
...
In Abhängigkeit von, wie die einzelnen Räder nun angetrieben werden, kann das Fahrzeug sich in alle Richtungen bewegen und um die eigene Achse drehen.
...
\paragraph{Encoder}
Ein Encoder detektiert die Umdrehungen eines Motors und wandelt diese in ein digitales Signal um. Mit diesem Signal kann die Steuerung den Motor präzise ansteuern.
