...
\begin{figure}[h!]
    \raggedright
    \includegraphics[width=0.15\textwidth]{img/Redlichkeitserklärung/Unterschrift_ThomasDietsche.png}
\end{figure}
\\
Bisang Joel
\\
...
\begin{figure}[h!]
    \raggedright
    \includegraphics[width=0.15\textwidth]{img/Redlichkeitserklärung/Unterschrift_Gian.png}
\end{figure}
