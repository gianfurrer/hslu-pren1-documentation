...
\subsubsection{Elektrotechnik}
        ...
        \resizebox{\textwidth}{!}{
         ...
         \renewcommand{\arraystretch}{1.5}
             \begin{tabular}{|c|>{\raggedright} p{3cm}|c|c|c|>{\raggedright} p{3cm}|c|c|>{\raggedright\arraybackslash}p{3cm}|}
                ...
                \textbf{Kriterium} & \textbf{Erklärung} & \textbf{Gewichtung} & \textbf{Bewertung} & \textbf{Punkte} & \textbf{Begründung} & \textbf{Bewertung} & \textbf{Punkte} & \textbf{Begründung} \\ \hline
                Libarys & Gibt es Bibliotheken für die Programmierung & 40 & 8 & 320 & Grosse Anuahl Online Libarys & 8 & 320 & McFun Bibliothek \\ \hline
                ...
                \multicolumn{2}{|r|}{\textbf{Nutzwert:}} & 100 & & 740 & & & 750 & \\ \hline
            \end{tabular}
         }
    ...
    Da der Unterschied nicht sehr gross ist, wird als erste Wahl der TinyK22 verwendet und das Arduino-Board als Ersatzwahl.

 \paragraph{Sensorik}
 Für die Wahl der richtigen Sensorik, müssen noch Tests durchgeführt werden. Vor allem für den Liniensensor und für die Erkennung des Wegpunktes. Für die Distanzmesssensoren ist ein Test zum Vergleich der Präzision zwischen Ultraschall und IR ebenso notwendig.
...
Dieser Abschnitt fokussiert sich darauf, von den vier Auswahlen die besste zu treffen.

\subparagraph{Nutzwertanalyse Objekterkennung}

Die passenste Objekterkennungsmethode wird anhand einer Nutzwertanalyse mit den folgenden Kriterien gewählt.
...
\item \textbf{Geschwindigkeit}: Die Bilder werden während dem Fahren analysiert. Eine schnelle Objekterkennungsmethode ist essentiell, damit das Fahrzeug schnell reagieren kann.
