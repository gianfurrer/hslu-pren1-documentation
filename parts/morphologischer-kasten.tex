...
\subsection{Vorauswahl}
    ...
    \subsubsection{Hindernis Bewältigung}
        ...
        \end{table}
            ...
            In der Nutzweranalyse erwähnt benötigt das Kriterium Prätision eine genauere erklärung.
            Die Präzision der Klemme Breitenweg kann besser erreicht werden als bei der Klemme Längsweg.\newline
            Einerseits weil wie in der Abbildung \ref{} und \ref{} gezeigt eine Zentrierung bei Klemme Breitenweg eingebaut werden kann.\newline
            Diese Zentrierung fällt bei der Klemme Längsweg und weil das Ziel ist, das Hindernis möglichst zentriert wieder auf dem Klebeband abzustellen, wird diese Korrektur hier vernachlässigt. In Abbildung \ref ist dargestellt, wenn das Fahrzeug nicht perfekt mittig auf das Hindernis zufährt, diese Korrektur auf diese Art nicht durchgeführt wird.
