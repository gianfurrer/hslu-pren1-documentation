...
\subsubsection{Hindernissbewältigungsantrieb}
...
Ebenso kann man ein Encoder verbauen für die Positionierung. Der Encoder kann auch wichtig sein, um die Fahrtrichtung zu kontrollieren. Sind die verwendeten DC-Motoren nicht identisch, so kann ein anderes Fahrverhalten pro Motor entstehen. Durch einen Encoder kann das Fehlverhalten abgefangen und korrigiert werden. (Wieso Encoder nicht hallsensor!!!!!!!)
