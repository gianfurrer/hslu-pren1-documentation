...
Ein Killerkriterium der Objekterkennung ist das 
...
\resizebox{\textwidth}{!}{
 ...
 \renewcommand{\arraystretch}{1.5}
     \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
        \hline
        \multicolumn{2}{|c|}{} & \multicolumn{2}{c|}{\textbf{CNN}} & \multicolumn{2}{c|}{\textbf{YOLO}} & \multicolumn{2}{c|}{\textbf{Haar-Cascade}} & \multicolumn{2}{c|}{\textbf{R-CNN}} \\ \hline
        ...
        \textbf{Nutzwert:} & 100 & & 615 & & 560 & & 1 && 1 \\ \hline
    \end{tabular}
 }
