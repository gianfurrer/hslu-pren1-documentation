...
Bei der Objekterkennung ist der Ressourcenbedarf ein sehr wichtiges Kriterium.
Da die Erkennung auf einem Raspberry Pi läuft und so viele Bilder pro Sekunde wie möglich analysieren 
