...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | Y | Y | Y |}
        ...
        Terminal &
        \cellcolor{LightGreen} Einfaches GUI \newline
        \includegraphics[width=3cm]{img/simulation/morphologischer-kasten/simple-gui.png}
        &
        Unreal Engine \newline
        \includegraphics[width=3cm]{simulation/morphologischer-kasten/unreal-engine-logo.png}
        \\ \hline
        ...
        \textbf{Informationen einlesen}  &     
        Bilder mit Objekterkennung &
        \cellcolor{LightGreen}
        Konfigurationsdatei &
        \\ \hline
        
        \textbf{Hindernis Bewältigung}   &     
        Immer umfahren &
