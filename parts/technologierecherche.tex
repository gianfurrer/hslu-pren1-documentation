...
E & Orientierung & Sensorik & Linienfolger & 5 & \href{https://www.elektronik-kompendium.de/sites/raspberry-pi/2802011.htm}{Link} & 27.09.2024 & Joel
...
\begin{items}
  \item [Vorteile]
  \item Effizient für kleine Graphen
  \item 
\end{items}
\end{minipage}
\hfill
...
\begin{items}
  \item [Nachteile]
  \item Kann langsamer sein als Dijkstra oder A* 
\end{items}
\end{minipage}
